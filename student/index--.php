            ...
            <div class="col-lg-4" style="margin: 0 0 26px 0;">
                <div class="card shadow-sm">
                  <div class="card-header bg-transparent text-center">
                    <img class="profile_img" src="../lgassets/images/student.jpg" alt="student dp">
                    <h3><?php echo $user["s_name"] ?></h3>
                  </div>
                  <div class="card-body">
                    <p class="mb-0"><strong class="pr-1">Student ID:</strong><?php echo $user["s_id"] ?></p>
                    <p class="mb-0"><strong class="pr-1">Section:</strong>A</p>
                    <a href="../lgassets/includes/logout.inc.php"><p class="mb-0"><strong class="pr-1">Logout</strong></p></a>
                  </div>
                </div>
              </div>
              <div class="col-lg-8">
