            ...
            <div class="card-body">
              ...
              <table class="table table-striped datatable">
                ...
                <tbody>
                  ...
                  try {
                    $sql = "SELECT * FROM tbl_subjects WHERE course = 'BSIT' AND year = '1' AND semester ='1' ";
            ...
            <div class="card-body">
              <table class="table table-striped datatable">
                ...
                <tbody>
                  ...
                  try {
                    $sql = "SELECT * FROM tbl_subjects WHERE course = 'BSIT' AND year = '1' AND semester ='2' ";
                    foreach ($db->query($sql) as $subject) {
                  ?>
                      <tr>
            ...
            <div class="card-body">
              ...
              <table class="table table-striped datatable">
                ...
                <tbody>
                  ...
                  try {
                    $sql = "SELECT * FROM tbl_subjects WHERE course = 'BSIT' AND year = '2' AND semester ='1'";
                    foreach ($db->query($sql) as $subject) {
                  ?>
                      <tr>
            ...
            <div class="card-body">
              <table class="table table-striped datatable">
                ...
                <tbody>
                  ...
                  try {
                    $sql = "SELECT * FROM tbl_subjects WHERE course = 'BSIT' AND year = '2' AND semester ='2'";
                    foreach ($db->query($sql) as $subject) {
                  ?>
                      <tr>
            ...
            <div class="card-body">
              ...
              <table class="table table-striped datatable">
                ...
                <tbody>
                  ...
                  try {
                    $sql = "SELECT * FROM tbl_subjects WHERE course = 'BSIT' AND year = '3' AND semester = '1'";
                    foreach ($db->query($sql) as $subject) {
                  ?>
                      <tr>
            ...
            <div class="card-body">
              ...
              <table class="table table-striped datatable">
                ...
                <tbody>
                  ...
                  try {
                    $sql = "SELECT * FROM tbl_subjects WHERE course = 'BSIT' AND year = '3' AND semester = '2'";
                    foreach ($db->query($sql) as $subject) {
                  ?>
                      <tr>
      ...
      <div class="row">
        <div class="col-12">
          <div class="card recent-sales overflow-auto">
            ...
            <div class="card-body">
              <h5 class="card-title">Course <span>| BSIT - SUMMER</span></h5>
              ...
              <table class="table table-striped datatable">
                ...
                <tbody>
                  ...
                  try {
                    $sql = "SELECT * FROM tbl_subjects WHERE course = 'BSIT-SUMMER' AND year = '3' ";
                    foreach ($db->query($sql) as $subject) {
                  ?>
                      <tr>
            ...
            <div class="card-body">
              ...
              <table class="table table-striped datatable">
                ...
                <tbody>
                  ...
                  try {
                    $sql = "SELECT * FROM tbl_subjects WHERE course = 'BSIT' AND year = '4' AND semester = '1'";
                    foreach ($db->query($sql) as $subject) {
                  ?>
                      <tr>
            ...
            <div class="card-body">
              ...
              <table class="table table-striped datatable">
                ...
                <tbody>
                  ...
                  try {
                    $sql = "SELECT * FROM tbl_subjects WHERE course = 'BSIT' AND year = '4' AND semester = '2'";
                    foreach ($db->query($sql) as $subject) {
                  ?>
                      <tr>
