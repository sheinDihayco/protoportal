...
<div class="container mt-4"> <!-- Adjust padding-top if header height is different -->

<!-- Time Slot Table and Form -->
<h2>Manage Time Slots</h2>
<button class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#timeSlotModal">Add Time Slot</button>

<table class="table table-striped" id="timesTable">
    <thead>
        <tr>
            <th>Start Time</th>
            <th>End Time</th>
    ...
    <tbody>
        <?php foreach ($timeSlots as $slot): ?>
            <tr>
                ...
                <td><button class="btn btn-primary edit-time" data-id="<?php echo $slot['time_id']; ?>" data-start="<?php echo htmlspecialchars($slot['start_time']); ?>" data-end="<?php echo htmlspecialchars($slot['end_time']); ?>">Edit</button></td>
                <td><button class="btn btn-danger delete-time" data-id="<?php echo $slot['time_id']; ?>">Delete</button></td>
            </tr>
        <?php endforeach; ?>
    </tbody>
</table>
    ...
    <tbody>
        <?php foreach ($rooms as $room): ?>
            <tr>
                ...
                <td><button class="btn btn-primary edit-room" data-id="<?php echo $room['room_id']; ?>" data-name="<?php echo htmlspecialchars($room['room_name']); ?>">Edit</button></td>
                <td><button class="btn btn-danger delete-room" data-id="<?php echo $room['room_id']; ?>">Delete</button></td>
            </tr>
        <?php endforeach; ?>
    </tbody>
</table>
