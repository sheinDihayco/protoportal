      ...
      <div class="row">
        <div class="col-12">
          <div class="card recent-sales overflow-auto">
            ...
            <div class="card-body">
              <h5 class="card-title">Course <span>| BSIT - 4 </span></h5>

              <table id="bsit4-table" class="table table-striped datatable">
                <thead>
                  <tr>
                ...
                <tbody>
                  ...
                  try {
                    $sql = "SELECT * FROM tbl_subjects WHERE course = 'BSIT' AND  year = '4' ";
              ...
              <button type="button" class="btn btn-sm btn-primary ri-printer-line" onclick="printTableBSIT4();"></button>
            </div>
      ...
      <div class="row">
        <div class="col-12">
          <div class="card recent-sales overflow-auto">
            ...
            <div class="card-body">
              <h5 class="card-title">Subject <span>| BSOA - 4 </span></h5>

              <table id="bsoa4-table" class="table table-striped datatable">
                <thead>
                  <tr>
                    <th scope="col">Semester</th>
                    <th scope="col">Code</th>
                ...
                <tbody>
                  ...
                  try {
                    $sql = "SELECT * FROM tbl_subjects WHERE course = 'BSOA' AND year = '4' ";
                    foreach ($db->query($sql) as $subject) {
                  ?>
                      <tr>
                        <td><?php echo htmlspecialchars($subject['semester']); ?></td>
              ...
              <button type="button" class="btn btn-sm btn-primary ri-printer-line" onclick="printTableBSOA4();"></button>
            </div>
      ...
      <div class="row">
        <div class="col-12">
          <div class="card recent-sales overflow-auto">
            ...
            <div class="card-body">
              <h5 class="card-title">Subject <span>| BSBA -4 </span></h5>

              <table id="bsba4-table" class="table table-striped datatable">
                <thead>
                  <tr>
                    <th scope="col">Semester</th>
                    <th scope="col">Code</th>
                ...
                <tbody>
                  ...
                  try {
                    $sql = "SELECT * FROM tbl_subjects WHERE course = 'BSBA' AND year = '4' ";
                    foreach ($db->query($sql) as $subject) {
                  ?>
                      <tr>
                        <td><?php echo htmlspecialchars($subject['semester']); ?></td>
              ...
              <button type="button" class="btn btn-sm btn-primary ri-printer-line" onclick="printTableBSBA4();"></button>
            </div>
...
<!--BSIT-->
<script>
  function printTableBSIT4() {
    // Open a new window for printing
    var printWindow = window.open('', '', 'height=600,width=800');

    // Select the HUMSS11 table specifically by its ID
    var table = document.querySelector('#bsit4-table');
    ...
    Object.keys(semesters).forEach(function(semester) {
      printDocument.write('<h3> BSIT 4 - ' + (semester === '1' ? 'First Semester' : 'Second Semester') + '</h3>');
...
<!--BSOA-->
<script>
  function printTableBSOA4() {
    // Open a new window for printing
    var printWindow = window.open('', '', 'height=600,width=800');

    // Select the HUMSS11 table specifically by its ID
    var table = document.querySelector('#bsoa4-table');
    ...
    // Iterate over semesters and create a table for each
    Object.keys(semesters).forEach(function(semester) {
      printDocument.write('<h3> BSOA 4 - ' + (semester === '1' ? 'First Semester' : 'Second Semester') + '</h3>');
...
<!--BSBA-->
<script>
  function printTableBSBA4() {
    // Open a new window for printing
    var printWindow = window.open('', '', 'height=600,width=800');

    // Select the HUMSS11 table specifically by its ID
    var table = document.querySelector('#bsba4-table');
    ...
    // Iterate over semesters and create a table for each
    Object.keys(semesters).forEach(function(semester) {
      printDocument.write('<h3> BSBA 4 - ' + (semester === '1' ? 'First Semester' : 'Second Semester') + '</h3>');
