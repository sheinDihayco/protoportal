    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <form action="../admin/upload/insert-student-records.php" method="post" class="row g-3 needs-validation" novalidate style="padding: 20px;">
            <div class="col-md-4">
            ...
            <div class="card recent-sales overflow-auto">
              ...
              <div class="filter">
                ...
                <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                  ...
                  <li><a class="dropdown-item" href="../admin/bsit.php">BSBA</a></li>
                  <li><a class=" dropdown-item" href="../admin/bsit.php">BSOA</a></li>
                </ul>
              </div>
                  ...
                  <tbody>
                    ...
                    ?>
                        <tr>
                          ...
                          <td><button type="button" class="ri-edit-2-fill" data-bs-toggle="modal" data-bs-target="#editStudentRecords<?php echo $row["studentID"] ?>"></button></td>
                          <?php include('modals/form-edit-student_records.php'); ?>
                        </tr>
                    <?php
                      }
