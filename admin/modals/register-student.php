    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content rounded-4 shadow-lg">
            <div class="modal-header border-bottom-0" style="background-color: #004d00; color: white; font-weight: bold;">
                <h5 class="modal-title" id="insertStudentLabel">Register Account</h5>
...
<style>
  /* Custom Modal Styles */
#insertStudent .modal-content {
    border-radius: 12px;
}

#insertStudent .modal-header {
    background-color: #004d00;
    color: white;
    font-weight: bold;
}

#insertStudent .modal-body input,
#insertStudent .modal-body select {
    font-size: 1.1rem;
    border-radius: 8px;
    padding: 10px;
}

#insertStudent .modal-footer {
    border-top: 1px solid #ddd;
    background-color: #f1f1f1;
}

#insertStudent .form-label {
    font-weight: bold;
}

#insertStudent .btn-primary {
    background-color: #28a745;
    border-color: #28a745;
}

#insertStudent .btn-primary:hover {
