        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="../admin/upload/insert-student-rec.php" method="post" class="row g-3 needs-validation" novalidate>
                                    ...
                                    <tbody>
                                        ...
                                        try {
                                            $sql = 'SELECT * FROM tbl_students
                                                    ORDER BY tbl_students.lname ASC';
                                            foreach ($db->query($sql) as $row) {
                                        ?>
                                                <tr>
                                                    <!--<td><a href="#editModal<?php echo htmlspecialchars($row['studentID']); ?>" class="btn" data-bs-toggle="modal"><?php echo $row["studentID"] ?> </a>
                                                    </td>-->
                                                    <th scope="row"><a href="#"><?php echo $row["studentID"] ?></a></th>
                                                    <td><?php echo $row["lname"] ?>, <?php echo $row["fname"] ?></td>
                                                    <td><?php echo $row["course"] ?> - <?php echo $row["year"] ?> </a></td>
                                                    <td><?php echo $row["contact"] ?></td>
                                                    <td>
                                                        <button type="button" class="ri-edit-2-fill" data-bs-toggle="modal" data-bs-target="#editModal<?php echo $row["studentID"] ?>">
                                                        </button>
                                                    </td>
