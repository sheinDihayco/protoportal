          ...
          <div class="card">
            ...
            <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade pt-3" id="profile-change-password">
                  ...
                  <form action="../admin/includes/change-pass-student.php" method="post" accept-charset="UTF-8">
    ...
    <?php if (isset($_SESSION['change_password']) && $_SESSION['change_password']): ?>
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = '../admin/index3.php';
            }
        });
    ...
    <?php if (isset($_SESSION['not_change_password']) && $_SESSION['not_change_password']): ?> 
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                window.location.href = '../admin/change-pass-student.php';  // Redirect to the change password page
            }
        });
