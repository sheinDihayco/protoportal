                ...
                if ($semester == 'all' || $semester == $semCode) {
                  ...
                  if ($stmt->rowCount() > 0) {
                    ...
                    foreach ($stmt as $subject) {
                      ...
                      echo "<td>";
                      echo '<button type="button" class="btn btn-sm btn-warning ri-edit-2-fill btn-edit" data-id="' . htmlspecialchars($subject['id'], ENT_QUOTES, 'UTF-8') . '" data-bs-toggle="modal" data-bs-target="#editCourseModal"></button>';
...
<div class="modal fade" id="editCourseModal" tabindex="-1" aria-labelledby="editCourseModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body" style="background-color:#e6ffe6;">
        <form id="editSubjectForm" action="functions/update-subject.php" method="POST">
