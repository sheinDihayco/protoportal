...
<?php include_once "../PHP/BSOA-con.php"; ?>
            ...
            <div class="card-body">
              ...
              <table class="table table-striped datatable">
                ...
                <tbody>
                  ...
                  try {
                    $sql = "SELECT * FROM tbl_subjects WHERE course = 'BSOA' AND year = '1' AND semester = '1' ";
            ...
            <div class="card-body">
              ...
              <table class="table table-striped datatable">
                ...
                <tbody>
                  ...
                  try {
                    $sql = "SELECT * FROM tbl_subjects WHERE course = 'BSOA' AND year = '1'AND semester = '2' ";
                    foreach ($db->query($sql) as $subject) {
                  ?>
                      <tr>
                        <td><?php echo htmlspecialchars($subject['year']); ?></td>
            ...
            <div class="card-body">
              ...
              <table class="table table-striped datatable">
                ...
                <tbody>
                  ...
                  try {
                    $sql = "SELECT * FROM tbl_subjects WHERE course = 'BSOA' AND year = '2' AND semester ='1' ";
                    foreach ($db->query($sql) as $subject) {
                  ?>
                      <tr>
                        <td><?php echo htmlspecialchars($subject['year']); ?></td>
            ...
            <div class="card-body">
              <table class="table table-striped datatable">
                ...
                <tbody>
                  ...
                  try {
                    $sql = "SELECT * FROM tbl_subjects WHERE course = 'BSOA' AND year = '2' AND semester ='2' ";
                    foreach ($db->query($sql) as $subject) {
                  ?>
                      <tr>
                        <td><?php echo htmlspecialchars($subject['year']); ?></td>
            ...
            <div class="card-body">
              ...
              <table class="table table-striped datatable">
                ...
                <tbody>
                  ...
                  try {
                    $sql = "SELECT * FROM tbl_subjects WHERE course = 'BSOA' AND year = '3' AND semester ='1' ";
                    foreach ($db->query($sql) as $subject) {
                  ?>
                      <tr>
                        <td><?php echo htmlspecialchars($subject['year']); ?></td>
            ...
            <div class="card-body">
              ...
              <table class="table table-striped datatable">
                ...
                <tbody>
                  ...
                  try {
                    $sql = "SELECT * FROM tbl_subjects WHERE course = 'BSOA' AND year = '3' AND semester = '2' ";
                    foreach ($db->query($sql) as $subject) {
                  ?>
                      <tr>
                        <td><?php echo htmlspecialchars($subject['year']); ?></td>
            ...
            <div class="card-body">
              ...
              <table class="table table-striped datatable">
                ...
                <tbody>
                  ...
                  try {
                    $sql = "SELECT * FROM tbl_subjects WHERE course = 'BSOA' AND year = '4' AND semester = '1'";
                    foreach ($db->query($sql) as $subject) {
                  ?>
                      <tr>
                        <td><?php echo htmlspecialchars($subject['year']); ?></td>
            ...
            <div class="card-body">
              ...
              <table class="table table-striped datatable">
                ...
                <tbody>
                  ...
                  try {
                    $sql = "SELECT * FROM tbl_subjects WHERE course = 'BSOA' AND year = '4' AND semester = '2' ";
                    foreach ($db->query($sql) as $subject) {
                  ?>
                      <tr>
                        <td><?php echo htmlspecialchars($subject['year']); ?></td>
